...
- Add admin pages and admin product pages
    ...
    19. delete products
        -create remove() method in model and delete method in route, middleware function is created in admin.controllers. 
            it doesn't work as it works with using post to delete. it need event listeners.
